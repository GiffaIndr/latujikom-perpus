    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3 text-secondary">PERPUS <sup>ADMIN</sup></div>
            </a>

            <!-- Divider -->
            <hr class="sidebar-divider bg-secondary my-0">
            ...
            <!-- Nav Item - Charts -->
            <li class="nav-item">
                <a class="nav-link" href="/dashboard/book">
                    <i class="fas fa-fw fa-book"></i>
                    <span class="text-secondary">Buku</span></a>
            </li>

            <!-- Nav Item - Tables -->
            <li class="nav-item">
                <a class="nav-link" href="/dashboard/pinjam">
                    <i class="fas fa-hand-holding"></i>
                    <span class="text-secondary">Peminjaman</span></a>
            </li>
@if(Auth::user()->role == 'admin')
            <li class="nav-item">
                <a class="nav-link" href="/dashboard/user">
                    <i class="fas fa-fw fa-user"></i>
                    <span class="text-secondary">User</span></a>
            </li>
@endif
            <li class="nav-item">
                <a class="nav-link" href="/dashboard/category">
                    <i class="fas fa-icons"></i>
                    <span class="text-secondary">category</span></a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('logout') }}">
                    ...
                    <span class="text-secondary">Logout</span></a>
            </li>
        </ul>
